...
<body class="bg-gradient-to-b from-blue-50 via-white to-gray-100 font-sans">
    ...
    <h1 class="mb-4 text-xl font-extrabold text-gray-900 md:text-2xl lg:text-3xl dark:text-dark text-center">Les cours disponibles </h1>
    <!-- Search Bar -->
            ...
            if ($courses && count($courses) > 0) {
                foreach ($courses as $course) {
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2"><?php echo htmlspecialchars($course['titre']); ?></h3>
